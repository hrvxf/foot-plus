...
export const metadata: Metadata = {
  ...
  description:
    "Foot+ provides professional home-visit foot care across selected areas of Bristol. Explore Clifton, Redland, Cotham, Bishopston, Henleaze, Westbury-on-Trym, Stoke Bishop, Sneyd Park, Southville and Bedminster.",
