...
export default function AnimatedFootPlusLogo({ className, animate = true }: Props) {
  ...
  return (
    ...
    >
      ...
      <g data-logo="toe" data-side="right" data-toe="3">
      ...
      <g data-logo="toe" data-side="right" data-toe="4">
