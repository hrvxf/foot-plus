                    ...
                    <span
                      ...
                      className={
                        chip.variant === "rainbow"
                          ? "rounded-full border border-white/35 bg-[linear-gradient(90deg,rgba(228,3,3,0.56),rgba(255,140,0,0.56),rgba(255,237,0,0.56),rgba(0,128,38,0.56),rgba(36,64,142,0.56),rgba(115,41,130,0.56))] px-3 py-1 text-xs font-medium text-white shadow-[0_8px_24px_-14px_rgba(0,0,0,0.7)]"
